...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36193 = c;
var G__36193__$1 = (((G__36193 == null))?null:G__36193.prototype);
if((G__36193__$1 == null)){
return null;
} else {
return G__36193__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36195 = c;
var G__36195__$1 = (((G__36195 == null))?null:G__36195.prototype);
if((G__36195__$1 == null)){
return null;
} else {
return G__36195__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__36260__delegate = function (args){
var G__36204 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__36204) : reagent.impl.component.as_element.call(null,G__36204));
};
...
return G__36260__delegate.call(this,args);};
G__36260.cljs$lang$maxFixedArity = 0;
G__36260.cljs$lang$applyTo = (function (arglist__36267){
var args = cljs.core.seq(arglist__36267);
return G__36260__delegate(args);
});
...
var G__36205 = c;
var G__36205__$1 = (((G__36205 == null))?null:G__36205.constructor);
if((G__36205__$1 == null)){
return null;
} else {
return G__36205__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__36208 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__36209 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__36209);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__36208);
}});
...
var c = this;
var G__36221_36290 = goog.object.get(c,"cljsRatom");
if((G__36221_36290 == null)){
} else {
reagent.ratom.dispose_BANG_(G__36221_36290);
}
...
var renders_36293 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_36294 = cljs.core.first(cljs.core.vals(renders_36293));
...
if((cljs.core.count(renders_36293) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_36293))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_36294)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_36294], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__36232 = o;
goog.object.set(G__36232,cljs.core.name(k),v);
