...
var G__36280 = o;
goog.object.set(G__36280,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__36330__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__36331__i < G__36331__a.length) {G__36331__a[G__36331__i] = arguments[G__36331__i + 0]; ++G__36331__i;}
  args = new cljs.core.IndexedSeq(G__36331__a,0,null);
} 
return G__36330__delegate.call(this,args);};
G__36330.cljs$lang$maxFixedArity = 0;
G__36330.cljs$lang$applyTo = (function (arglist__36332){
var args = cljs.core.seq(arglist__36332);
return G__36330__delegate(args);
});
...
var G__36291 = props;
var G__36291__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36291,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__36291);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36291__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__36291__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__36292 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36292,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__36292;
}
})(),id_class);
...
return (jsprops.onChange = (function (p1__36305_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__36305_SHARP_);
}));
} else {
return null;
}
...
var vec__36307 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36307,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36307,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36307,(2),null);
...
var temp__5739__auto___36351 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___36351 == null)){
} else {
var key_36352 = temp__5739__auto___36351;
(jsprops.key = key_36352);
}
...
var temp__5739__auto___36353 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___36353 == null)){
} else {
var key_36354 = temp__5739__auto___36353;
(jsprops.key = key_36354);
}
...
var G__36311 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__36311) : reagent.impl.template.as_element.call(null,G__36311));
} else {
var temp__5739__auto___36355 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___36355 == null)){
} else {
var key_36356 = temp__5739__auto___36355;
(jsprops.key = key_36356);
}
...
var G__36313 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__36313)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq36314){
var G__36315 = cljs.core.first(seq36314);
var seq36314__$1 = cljs.core.next(seq36314);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36315,seq36314__$1);
}));
