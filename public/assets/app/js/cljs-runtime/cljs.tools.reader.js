...
var G__26808 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__26808;
continue;
}
break;
...
if(("\\" === ch__$1)){
var ch_26809__$2 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
if((ch_26809__$2 == null)){
...
sb.append(ch_26809__$2);
} else {
}

var G__26812 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch__$1 = G__26812;
continue;
}
}
...
var G__26834 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(a,form);
a = G__26834;
continue;
}
}
...
var G__26838 = (function (){var G__26666 = sb;
G__26666.append(ch);
...
switch (G__26671) {
case "\\":
var G__26850 = (function (){var G__26672 = sb;
G__26672.append(cljs.tools.reader.escape_char(sb,reader));

return G__26672;
})();
var G__26851 = reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
sb = G__26850;
ch = G__26851;
continue;
...
break;
default:
var G__26852 = (function (){var G__26673 = sb;
G__26673.append(ch);

return G__26673;
})();
var G__26853 = reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
sb = G__26852;
ch = G__26853;
continue;
...
var vec__26674 = cljs.tools.reader.ending_line_col_info(rdr);
var end_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26674,(0),null);
var end_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26674,(1),null);
...
var vec__26678 = cljs.tools.reader.starting_line_col_info(rdr);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26678,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26678,(1),null);
...
var G__26889 = matched;
var G__26890 = cljs.tools.reader.read_suppress(first_line,rdr,opts,pending_forms);
matched = G__26889;
finished = G__26890;
continue;
} else {
...
var ch = temp__5733__auto__;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("@",ch)){
return cljs.tools.reader.wrapping_reader(new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null))((function (){var G__26744 = rdr;
G__26744.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
...
var G__26931 = cljs.core.next(s__$1);
var G__26932 = ret;
s__$1 = G__26931;
r = G__26932;
continue;
...
var G__26934 = cljs.core.next(s);
var G__26935 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(key_vals,cljs.core.key(e)),cljs.core.val(e));
s = G__26934;
key_vals = G__26935;
continue;
} else {
...
return (new cljs.core.List(null,new cljs.core.Symbol("cljs.core","with-meta","cljs.core/with-meta",749126446,null),(new cljs.core.List(null,ret,(new cljs.core.List(null,(function (){var G__26754 = cljs.core.meta(form);
return (cljs.tools.reader.syntax_quote_STAR_.cljs$core$IFn$_invoke$arity$1 ? cljs.tools.reader.syntax_quote_STAR_.cljs$core$IFn$_invoke$arity$1(G__26754) : cljs.tools.reader.syntax_quote_STAR_.call(null,G__26754));
...
var gensym_env_orig_val__26768 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__26769 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__26769);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__26768);
}});
...
var temp__5733__auto__ = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(token,":"))?cljs.core.ns_name(cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(":",cljs.core.first(token)))?(function (){var G__26771 = token;
var G__26771__$1 = (((G__26771 == null))?null:cljs.core.subs.cljs$core$IFn$_invoke$arity$2(G__26771,(1)));
var G__26771__$2 = (((G__26771__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol(G__26771__$1));
var G__26771__$3 = (((G__26771__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_(G__26771__$2));
var G__26771__$4 = (((G__26771__$3 == null))?null:cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(G__26771__$3));
if((G__26771__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns(G__26771__$4);
}
})():(function (){var G__26772 = token;
var G__26772__$1 = (((G__26772 == null))?null:cljs.tools.reader.impl.commons.parse_symbol(G__26772));
if((G__26772__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_(G__26772__$1);
}
})()
));
if(cljs.core.truth_(temp__5733__auto__)){
...
var G__26778 = (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(rdr,true,null,opts,pending_forms) : cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
...
var G__26780 = tag;
var G__26781 = (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(rdr,true,null,opts,pending_forms) : cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__26780,G__26781) : f.call(null,G__26780,G__26781));
} else {
...
}catch (e26785){if((e26785 instanceof Error)){
var e = e26785;
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__26790,reader){
var map__26791 = p__26790;
var map__26791__$1 = (((((!((map__26791 == null))))?(((((map__26791.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__26791.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__26791):map__26791);
var opts = map__26791__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__26791__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
